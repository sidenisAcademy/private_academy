package Trefilova.PetSteps;

import Trefilova.Pets.PetModels.Category;
import Trefilova.Pets.PetModels.Pet;
import Trefilova.Pets.PetModels.Tags;

import java.util.ArrayList;
import java.util.List;


import static Trefilova.Pets.PetController.PetController.*;
